...
public:
     ...
     */
    SoilMoistureSensor(int analogPin, int floatingThreshold = SOIL_MOISTURE_FLOATING_THRESHOLD, int wetThreshold = SOIL_MOISTURE_THRESHOLD, int analogMax = 4095, int dryValue = 4095, int wetValue = 0);
